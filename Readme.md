...
- รองรับคำภาษามือในภาษาไทยจำนวน 20 คำ
- หากผู้แสดงท่าทางอยู่ไกลจากกล้องมากเกินไป จะไม่สามารถตรวจจับมือของผู้แสดงได้
- ต้องมีการเอามือลงให้พ้นระยะกล้องเพื่อแบ่งการประมวลผลระหว่างท่า

และในอนาคตสามารถพัฒนาการทำงานของโปรแกรมเพิ่มเติมได้โดย
- เพิ่มจำนวนข้อมูลของแต่ละท่า และเพิ่มจำนวนท่าทางให้มากขึ้น
- เพิ่มการใช้อุปกรณ์พิเศษ เช่น Microsoft Kinect หรือการใช้กล้องอย่างน้อย 2 ตัวขึ้นไปเพื่อรองรับข้อมูลในแนวลึก
- ปรับปรุง Machine Learning Model ที่ใช้ได้การตรวจจับท่าทางให้รองรับระยะห่างระหว่างผู้แสดงกับกล้องให้มากขึ้น
- ปรับให้ระบบแปลคำต่อเนื่องจนเป็นประโยคได้ โดยที่ผู้แสดงท่าทางไม่จำเป็นต้องยกมือลง
- ปรับปรุงให้ระบบสามารถแปลคำจากท่าทางที่คล้ายคลึงกันได้ เช่น คำว่า ชอบ - ไม่ชอบ โดยอาจจะแบ่งเป็น State สำหรับคำย่อย เช่นคำว่าไม่ชอบ เป็นท่าของคำว่า ชอบ ต่อด้วยคำว่า ไม่
- คำบางคำอาจใช้สีหน้าในการช่วยแปล ในอนาคตอาจจะเพิ่มการตรวจจับใบหน้าเข้ามาในโมเดลด้วย
